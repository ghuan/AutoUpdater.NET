...
namespace AutoUpdaterDotNET
{
    ...
    public static class AutoUpdater
    {
        ...
        /// <param name="myAssembly">Assembly to use for version checking.</param>
        public static int CheckUpdate(string appCast, Assembly myAssembly = null) {
            try {
                ...
                args.InstalledVersion = InstalledVersion != null ? InstalledVersion : assembly.GetName().Version;
                if (new Version(args.CurrentVersion) > args.InstalledVersion)
                {
                    return 1;
                }
                else
